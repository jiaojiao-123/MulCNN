...
# 数据集选择
train_name = []
train_name.append('/home/aita/4444/jiao/cellclassification/mydata/Segerstolpe/train.csv')  # Segerstolpe,Lawlor,Baron,Xin
test_name = []
test_name.append('/home/aita/4444/jiao/cellclassification/mydata/Segerstolpe/test.csv')
valid_name = []
valid_name.append('/home/aita/4444/jiao/cellclassification/mydata/Segerstolpe/valid.csv')
bridge_name = []
bridge_name.append('/home/aita/4444/jiao/cellclassification/mydata/Segerstolpe/bridge.csv')
# model_name = []
